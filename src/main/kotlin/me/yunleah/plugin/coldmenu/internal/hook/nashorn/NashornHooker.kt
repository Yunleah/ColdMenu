package me.yunleah.plugin.coldmenu.internal.hook.nashorn
...
/**
 * ColdMenu
 * me.yunleah.plugin.coldmenu.internal.hook.nashorn
 *
 * @author Yunleah763
 * @since 2023/8/10 17:59
 */
/**
 * nashorn挂钩
 */
abstract class NashornHooker {
     ...
     * @return 返回值
     */
    abstract fun invoke(compiledScript: me.yunleah.plugin.coldmenu.internal.script.CompiledScript, function: String, map: Map<String, Any>?, vararg args: Any): Any?
